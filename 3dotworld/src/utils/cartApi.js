...
/**
 * Apply coupon to cart - UPDATED to use coupon routes
...
export const applyCoupon = async (code) => {
  try {
    ...
    // ✅ CHANGED: Use coupon routes instead of cart routes
    const response = await api.post('/coupons/apply-coupon', { code: formattedCode });
...
/**
 * Remove coupon from cart - UPDATED to use coupon routes
 * @returns {Promise} - Updated cart without discount
 */
export const removeCoupon = async () => {
  try {
    // ✅ CHANGED: Use coupon routes instead of cart routes
    const response = await api.delete('/coupons/remove-coupon');
    return response.data;
  } catch (error) {
