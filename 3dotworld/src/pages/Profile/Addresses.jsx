...
const Addresses = () => {
  ...
  const fetchAddresses = async () => {
    try {
      ...
      const response = await axios.get("https://server-kzwj.onrender.com/api/addresses", {
        headers: {
    ...
    try {
      ...
      if (editMode && currentAddress) {
        ...
        response = await axios.put(
          `https://server-kzwj.onrender.com/api/addresses/${currentAddress._id}`,
          formData,
          {
            headers: {
              'Authorization': `Bearer ${token}`
        ...
        response = await axios.post(
          "https://server-kzwj.onrender.com/api/addresses",
          formData,
          {
            headers: {
              'Authorization': `Bearer ${token}`
  ...
  const handleDeleteAddress = async (addressId) => {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://server-kzwj.onrender.com/api/addresses/${addressId}`,
        {
          headers: {
            'Authorization': `Bearer ${token}`
          }
  ...
  const handleSetDefault = async (addressId) => {
    try {
      ...
      const response = await axios.put(
        `https://server-kzwj.onrender.com/api/addresses/${addressId}/set-default`,
        {},
        {
          headers: {
            'Authorization': `Bearer ${token}`
