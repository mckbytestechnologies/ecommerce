...
const Search = () => {
    ...
    const fetchResults = async () => {
      try {
        ...
        const [productRes, categoryRes] = await Promise.all([
          axios.get(`https://server-kzwj.onrender.com/api/products?search=${query}`),
          axios.get(`https://server-kzwj.onrender.com/api/categories?search=${query}`)
        ]);
  ...
  const goToCategory = (name) => {
    setOpen(false);
    setQuery("");
    navigate(`/productlisting?category=${encodeURIComponent(name)}`);
  };
